...
const Register = () => {
  ...
  const getPasswordStrength = (password) => {
    ...
    if (strength <= 2) return { strength: 25, text: 'Weak', color: 'danger' };
    if (strength === 3) return { strength: 50, text: 'Fair', color: 'warning' };
    if (strength === 4) return { strength: 75, text: 'Good', color: 'info' };
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="position-relative">
                      <input
                        type="text"
                        id="name"
                        className={`form-control form-control-lg border-2 ${errors.name ? 'is-invalid border-danger' : 'border-light'}`}
                  ...
                  <div className="mb-4">
                    ...
                    <div className="position-relative">
                      <input
                        ...
                        id="confirmPassword"
                        className={`form-control form-control-lg border-2 ${errors.confirmPassword ? 'is-invalid border-danger' : 'border-light'}`}
                      ...
                      />
                      <i 
                        className="bi bi-shield-lock-fill position-absolute text-muted"
                        style={{ 
                          left: '16px', 
                          top: '50%', 
                          transform: 'translateY(-50%)',
                      ...
                      >
                        <i 
                          className={`bi ${showConfirmPassword ? 'bi-eye-slash-fill' : 'bi-eye-fill'} text-muted`}
                          style={{ fontSize: '1.1rem' }}
                        ></i>
                      </button>
                  ...
                  <div className="mb-4">
                    <div className="form-check">
                      ...
                      >
                        I agree to the{' '}
                        <Link to="/terms" className="text-decoration-none fw-medium" style={{ color: '#667eea' }}>
                          Terms of Service
                        </Link>{' '}
                        and{' '}
                        <Link to="/privacy" className="text-decoration-none fw-medium" style={{ color: '#667eea' }}>
                          Privacy Policy
                        </Link>
                      </label>
                    </div>
